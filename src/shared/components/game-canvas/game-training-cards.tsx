...
const scenarios = [
  {
    id: 1,
    text: 'Перед вами 5 пар карт одного цвета. Нажмите на карту, чтобы увидеть ее цвет. Запоминайте расположение карт и найдите все пары. Отрывая пару карт, вы наносите урон противнику.'
  },
  {
    id: 2,
    text: 'Отлично! Вы открыли одну пару и нанесли урон противнику! Теперь заметьте, когда противник атакует, один из его элементов окрашивается в определенный цвет. Если вы нажмете на карту этого цвета, то отразите атаку и не получите урон. Попробуйте отразить атаку противника!'
  },
  {
    id: 3,
    text: 'Невероятно! Вы научились парировать атаки противника! За каждый урон, нанесенный противнику, вы получаете энергию. Полученная энергия отображается на голубой колбе энергии.'
  },
  {
    id: 4,
    text: 'Учтите что противник вас так же атакует и может парировать ваши атаки. Рядом с колбой полученной энергии есть кнопка сердечко, нажмите на нее что бы восстановить здоровье. Доведите бой до победного конца!'
  }
]
