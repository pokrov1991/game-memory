...
const scenarios = [
  ...
  {
    id: 3,
    text: 'Невероятно! Вы научились парировать атаки противника! За каждый урон, нанесенный противнику, вы получаете опыт. Полученный опыт отображается на голубой колбе опыта.'
  },
  {
    id: 4,
    text: 'Учтите что противник вас так же атакует и может парировать ваши атаки. Рядом с колбой полученного опыта есть кнопка сердечко, нажмите на нее что бы восстановить здоровье. Доведите бой до победного конца!'
  }
]
